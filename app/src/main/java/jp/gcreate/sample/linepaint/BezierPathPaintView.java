 ...
 */
public class BezierPathPaintView extends View implements View.OnTouchListener{
    ...
    public BezierPathPaintView(Context context) {
        this(context, null);
    }

    public BezierPathPaintView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezierPathPaintView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BezierPathPaintView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
